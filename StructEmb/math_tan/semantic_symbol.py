    ...
    def parse_from_mathml(cls, elem, parent=None, identified=None):
        ...
        # generic tag operators
            ...
            if cd == "latexml":
                ...
                if content in ["annotated", "approaches-limit", "approximately-equals-or-image-of",
                               ...
                               "currency-dollar", "degree", "difference-between",
                               "dimension", "direct-product", "direct-sum", "divides", "does-not-prove",
                               "double-integral", "double-subset-of", "double-superset-of",
                               ...
                               "image-of-or-approximately-equals", "infimum", "infinity",
                               "injective-limit",
                               ...
                               "percent", "perpendicular-to", "plus-or-minus",
                               ...
                               "product", "projective-limit", "proportional-to", "proves",
                               ...
                               "square-original-of", "square-original-of-or-equals",
                               ...
                               "supremum", "therefore", "top", "triple-integral",
                ...
                if content in ["qvar_$", "qvar_^", "qvar_missing", "qvar_.", "qvar_"]:
